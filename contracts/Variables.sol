...
contract Variables6 {
    ...
    string name1 = "Name 1";
    function nameOne() public returns (string memory) {}
...
contract TestHelper is Variables6 {
    function getInternalName1() external view returns (string memory) {
        return name1;
    }

    function getInternalName3() external view returns (string memory) {
        return name3;
    }
}
